...
namespace ClassLeak202606\PhpParser\Node;

use ClassLeak202606\PhpParser\Modifiers;
use ClassLeak202606\PhpParser\Node\Expr\Assign;
use ClassLeak202606\PhpParser\Node\Expr\PropertyFetch;
use ClassLeak202606\PhpParser\Node\Expr\Variable;
use ClassLeak202606\PhpParser\Node\Stmt\Expression;
use ClassLeak202606\PhpParser\Node\Stmt\Return_;
use ClassLeak202606\PhpParser\NodeAbstract;
