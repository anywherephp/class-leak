...
namespace ClassLeak202606\PhpParser\Lexer;

use ClassLeak202606\PhpParser\Error;
use ClassLeak202606\PhpParser\ErrorHandler;
use ClassLeak202606\PhpParser\Lexer;
use ClassLeak202606\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use ClassLeak202606\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use ClassLeak202606\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use ClassLeak202606\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use ClassLeak202606\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use ClassLeak202606\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use ClassLeak202606\PhpParser\Lexer\TokenEmulator\PipeOperatorEmulator;
use ClassLeak202606\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use ClassLeak202606\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use ClassLeak202606\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use ClassLeak202606\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use ClassLeak202606\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use ClassLeak202606\PhpParser\Lexer\TokenEmulator\VoidCastEmulator;
use ClassLeak202606\PhpParser\PhpVersion;
use ClassLeak202606\PhpParser\Token;
