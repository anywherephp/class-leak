 ...
 */
namespace ClassLeak202606\Composer;

use ClassLeak202606\Composer\Autoload\ClassLoader;
use ClassLeak202606\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ClassLeak202606\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
