 ...
 */
namespace ClassLeak202606\Nette\Utils;

use ClassLeak202606\JetBrains\PhpStorm\Language;
use ClassLeak202606\Nette;
...
class Strings
{
    ...
    #[\ClassLeak202606\Deprecated('use Strings::TrimCharacters')]
