...
use ClassLeak202606\Nette\Utils\FileSystem;
...
final class FileWithClass implements JsonSerializable
{
    ...
    {
        $fileContents = FileSystem::read($this->filePath);
        if (\strpos($fileContents, 'ClassLeak202606\\Doctrine\\ODM\\MongoDB\\Mapping\\Annotations') !== \false) {
            return \true;
        }
        if (\strpos($fileContents, 'ClassLeak202606\\Doctrine\\ORM\\Annotations') !== \false) {
            return \true;
        }
